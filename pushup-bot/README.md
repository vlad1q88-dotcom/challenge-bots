...
Три варианта лежат в `docs/avatar-a.png`, `docs/avatar-b.png`, `docs/avatar-c.png`
и перерисовываются командой `node scripts/make-avatar.ts`. Ставится вручную через
